...
nnoremap <nowait> <C-e> :echo "C-e"<CR>
nnoremap <nowait> <C-r> :echo "C-r"<CR>
...
nnoremap <nowait> <C-s> :echo "C-s"<CR>
nnoremap <nowait> <C-d> :echo "C-d"<CR>
nnoremap <nowait> <C-f> :echo "C-f"<CR>
nnoremap <nowait> <C-g> :echo "C-g"<CR>
nnoremap <nowait> <C-h> :echo "C-h"<CR>
nnoremap <nowait> <C-j> :echo "C-j"<CR>
nnoremap <nowait> <C-k> :echo "C-k"<CR>
nnoremap <nowait> <C-l> :echo "C-l"<CR>
nnoremap <nowait> <C-;> :echo "C-;"<CR>
nnoremap <nowait> <C-'> :echo "C-'"<CR>
nnoremap <nowait> <C-CR> :echo "C-CR"<CR>
nnoremap <nowait> <C-z> :echo "C-z"<CR>
nnoremap <nowait> <C-x> :echo "C-x"<CR>
nnoremap <nowait> <C-c> :echo "C-c"<CR>
nnoremap <nowait> <C-v> :echo "C-v"<CR>
nnoremap <nowait> <C-b> :echo "C-b"<CR>
nnoremap <nowait> <C-n> :echo "C-n"<CR>
nnoremap <nowait> <C-m> :echo "C-m"<CR>
nnoremap <nowait> <C-,> :echo "C-,"<CR>
nnoremap <nowait> <C-.> :echo "C-."<CR>
nnoremap <nowait> <C-/> :echo "C-/"<CR>
