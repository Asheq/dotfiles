...
-- Make <C-j> to accept selected completion item or notify coc.nvim to format
...
function _G.show_docs()
	...
	elseif vim.api.nvim_eval("coc#rpc#ready()") then
		...
		vim.api.nvim_command("!" .. vim.opt.keywordprg:get() .. " " .. cw)
	end
end
...
keyset("n", "<BS>ac", "<Plug>(coc-codeaction-cursor)", opts)
-- Remap keys for apply source code actions for current file.
keyset("n", "<BS>as", "<Plug>(coc-codeaction-source)", opts)
-- Apply the most preferred quickfix action on the current line.
keyset("n", "<BS>qf", "<Plug>(coc-fix-current)", opts)
...
keyset("n", "<BS>a", ":<C-u>CocList diagnostics<cr>", opts)
-- Manage extensions
keyset("n", "<BS>e", ":<C-u>CocList extensions<cr>", opts)
-- Show commands
keyset("n", "<BS>c", ":<C-u>CocList commands<cr>", opts)
-- Find symbol of current document
keyset("n", "<BS>o", ":<C-u>CocList outline<cr>", opts)
-- Search workspace symbols
keyset("n", "<BS>s", ":<C-u>CocList -I symbols<cr>", opts)
-- Do default action for next item
keyset("n", "<BS>j", ":<C-u>CocNext<cr>", opts)
-- Do default action for previous item
keyset("n", "<BS>k", ":<C-u>CocPrev<cr>", opts)
-- Resume latest coc list
keyset("n", "<BS>p", ":<C-u>CocListResume<cr>", opts)
-- Show files
keyset("n", "<BS>f", ":<C-u>CocList files<cr>", opts)
-- Show buffers
keyset("n", "<BS>b", ":<C-u>CocList buffers<cr>", opts)
-- Show most recent
keyset("n", "<BS>m", ":<C-u>CocList mru<cr>", opts)
