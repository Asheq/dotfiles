...
# Terminal
# ==============================================================================
alias dark=" kitty +kitten themes --config-file-name ~/.config/kitty/theme.conf --reload-in=all Gruvbox Dark"
alias light="kitty +kitten themes --config-file-name ~/.config/kitty/theme.conf --reload-in=all Gruvbox Light"
